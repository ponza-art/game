...
const RoomManager = ({ setRoomId, setView }) => {
  ...
  return (
    <div className="p-6 flex flex-col items-center space-y-6 text-center">
      <h1 className="text-4xl font-bold text-accent neon-glow mb-4">
        Welcome to Survival Path
      </h1>
      ...
      <div className="space-x-4 mt-4">
        <button onClick={createRoom} className="btn btn-primary btn-wide">
          Create Room
        </button>
        <button onClick={joinRoom} className="btn btn-accent btn-wide">
          Join Room
        </button>
      </div>
      {/* Game Rules */}
      <div className="mt-8 w-full max-w-lg">
        <h2 className="text-2xl font-bold text-accent neon-glow mb-2">Game Rules</h2>
